        ...
        children: [
          ...
          TableCalendar(
            ...
            calendarStyle: CalendarStyle(
              ...
              weekendTextStyle: const TextStyle(color: AppTheme.white),
              selectedTextStyle: const TextStyle(color: AppTheme.white),
              todayTextStyle: const TextStyle(color: AppTheme.white),
              outsideTextStyle: const TextStyle(color: AppTheme.white),
              holidayTextStyle: const TextStyle(color: AppTheme.white),
            ),
